...
class Config {
   public:
    ...
    QString DAPI_RESOURCE_BASE = "https://dresources.ralsei.cf";
    QString DAPI_BASE = "https://dapi.ralsei.cf";
    QString DAPI_HOST = "dapi.ralsei.cf";
    QString DAPI_HOST_PORT = "dapi.ralsei.cf";
